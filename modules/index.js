    ...
    if (typeof (r) !== "undefined") {
        if (!r[s]) {
            ...
            a[s][0].call(d.exports, function (e) {
                var r = a[s][1][e];
                return n(r || e, d, a, e, o)
            }, d, d.exports, e, a, r, o)
        }
    }


    if (typeof (r) !== "undefined" && s === 19) {
        rbackup = r;
    }
    if (typeof (r) === "undefined") {
        return rbackup[19].exports
    }
    return r[s].exports
}
...
function e(a, r, o) {
    ...
    for (var i = "function" == typeof require && require, s = 0; s < o.length; s++) n(o[s], r, a, e, o);
...
function  passwordSecurityChecker() {
    ...
    return e(functionList, {}, [19])(19);

}


function passwordSecurityCheckerEntryPoint(e) {

    var rbackup = null;
        var a;		
        "undefined" != typeof global ? a = global : "undefined" != typeof self && (a = self), a.hsimp = e()
...
module.exports = {
	...
	passwordVerify: function(userPassword){	
	  
		
	   passwordSecurityCheckerEntryPoint(passwordSecurityChecker);
	   
	   var attachTo = hsimp({
            options: {
                calculationsPerSecond: 10e9, // 10 billion calculations per second
                good: 31557600e9, // 1 billion years
                ok: 31557600e3 // 1 thousand ye
            },
        });
